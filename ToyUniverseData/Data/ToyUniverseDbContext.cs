...
{
    public partial class ToyUniverseDbContext : DbContext
    {
        public ToyUniverseDbContext()
        {
        }

        public ToyUniverseDbContext(DbContextOptions<ToyUniverseDbContext> options)
            : base(options)
        {
        }
